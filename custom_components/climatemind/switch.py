"""Switch platform for ClimateMind."""
...
def _create_room_switches(
    ...
    return [ClimateMindCoverAutoSwitch(coordinator, area_id)]
...
async def async_setup_entry(
    ...
    """Set up ClimateMind switch entities from a config entry."""
    ...
    entities: list[SwitchEntity] = [ClimateMindVacationSwitch(coordinator)]

    rooms = store.get_rooms()
    for area_id, room in rooms.items():
        entities.append(ClimateMindClimateControlSwitch(coordinator, area_id))
...
class ClimateMindCoverAutoSwitch(CoordinatorEntity, SwitchEntity):
...
class ClimateMindClimateControlSwitch(CoordinatorEntity, SwitchEntity):
    _attr_has_entity_name = True
...
class ClimateMindVacationSwitch(CoordinatorEntity, SwitchEntity):
