"""Cover/blind manager for ClimateMind smart home control."""
...
class _RoomCoverState:
    ...
    owned: bool = False  # current position was produced by ClimateMind
...
class CoverManager:
    ...
    def update_position(self, area_id: str, position: int, override_minutes: int = COVER_USER_OVERRIDE_MINUTES) -> None:
        ...
        target is ClimateMind's own motion. Anything else arms a user override
        for ``override_minutes``, releases ClimateMind's ownership of the
